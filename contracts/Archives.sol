...
contract Archives is Whitelist {
    ...
    struct Artwork {
        ...
        string dataHash; //stores the hash generated by IPFS to retrieve all the information about the Artwork
    ...
    function publishArtwork(string _name, string _descriptionHash, string _dataHash) public {
        //new artw
        artworkCounter++;
        ...
        emit LogSendArtw(artworkCounter, msg.sender, _name, _descriptionHash, _dataHash, false);
    }
    ...
    //manual artwork adding for testing purposes - Just for tests and current constructor to be removed!
    function addArtwork(uint _id, address _author, string _name, string _descriptionHash, string _dataHash, bool _validation, uint _votesNum) public {
        artworkCounter++;
        artworks[artworkCounter] = Artwork (
            _id,
            _author,
