...
contract Archives is Whitelist {
    ...
    //Struct data type containg all artwork proprieties
    struct Artwork {
        uint id;
        address author;
        string name;
    ...
    //adding examples articles when deploying contract
    constructor() public  {
    ...
    //manual artwork adding for testing purposes
    ...
    //artwork checker can switch the propriety artwork.validation to true
