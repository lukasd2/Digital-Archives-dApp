...
contract Archives is Whitelist {
    ...
    struct Artwork {
        ...
        string name;
        string description; //short Artwork description (may not be necessary, depends on the final encoding tech)
    ...
    function addArtwork(uint _id, address _author, string _name, string _description, string _dataHash, bool _validation, uint _votesNum) public {
        artworkCounter++;
        artworks[artworkCounter] = Artwork (
            _id,
            _author,
